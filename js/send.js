function sendSubmit() {
    ...
    //const course = document.querySelectorAll('input#course').value;
    const institution = document.querySelectorAll('input#institution').value;
    const conclusion = document.getElementById('conclusion').value;
    const year = document.querySelectorAll('input#year').value;
    const local = document.querySelectorAll('input#local').value;
    const yearIn = document.querySelectorAll('input#yearIn').value;
    const yearTo = document.querySelectorAll('input#yearTo').value;
    const activies = document.getElementById('activies').value;
    const qualification = document.querySelectorAll('input#qualification').value;
    const nivelQ = document.getElementById('nivelQ').value;
    const language = document.querySelectorAll('input#language').value;
    ...
    sessionStorage.setItem("COURSE", arrAcademic);
    ...
    sessionStorage.setItem("LANGUAGE", JSON.stringify(newDict7));
